    ...
    <section>
        ...
        <article id="quisommesnous">
            ...
            <div class="quisommesnous">
                <a href="#"><img src="public/images/logo/logo"></a>
                <div class="text">
            ...
            <div class="troisiemebloc">
                ...
                <article class="photo">
                    ...
                    <img src="logo_Chais_Pinot/vin%20et%20verre.jpg" width="135">
                    <div id="slider">
                        <figure>
...
<?php require('template_site_fr.php'); ?>